//! Test vectors.
//!
//!   rfc9001_*  packet protection, RFC 9001 Appendix A
//!   rfc8448_*  the TLS 1.3 handshake trace, RFC 8448 s3
...
// --- RFC 9001 Appendix A: packet protection ---

/// The client-chosen Destination Connection ID every Appendix A vector uses.
/// Source: RFC 9001 s A.
pub const rfc9001_dcid = "8394c8f03e515708";

/// An id unrelated to the RFC's, for tests that build their own packets.
pub const other_dcid = "0011223344556677";

/// RFC 8448's client x25519 private key, reused so a probe's first flight is
/// byte-identical every run.
///
/// Published, therefore secret to nobody: a session using it has no forward
/// secrecy. Tests and probes only, never a default.
pub const fixed_x25519_secret = "49af42ba7f7994852d713ef2784bcbcaa7911de26adc5642cb634540e7ea5005";
...
/// The CRYPTO frame carried in that packet once decrypted, 245 bytes. The
/// rest of the 1162-byte payload is PADDING frames (zero bytes).
pub const rfc9001_client_crypto_hex =
...
// --- RFC 8448 s3: the TLS 1.3 handshake trace ---

/// ClientHello, 196 bytes.
pub const rfc8448_client_hello_hex =
...
pub const rfc8448_server_hello_hex =
...
/// RFC 9001 A.3 server Initial, protected, 135 bytes.
pub const rfc9001_server_initial_hex =
    ...
    "2158407dd074ee";
/// Its decrypted payload: an ACK frame then a CRYPTO frame, 99 bytes.
pub const rfc9001_server_payload_hex =
